...
export default function Signup({ navigation }) {
  ...
  const handleValidation = () => {
    ...
    if (phoneNumber && phoneNumber.length < 11)
      errors.password = "Phone number has to be a min of 11 digits.";
      ...
      <StatusBar style="light" />
        <ScrollView keyboardDismissMode="on-drag">
          ...
          <View style={styles.rememberContainer}>
            <Text style={[styles.rememberMe, styles.defaultFont]}>
              Remember me
            </Text>
          ...
          <View style={styles.loginContainer}>
            <Pressable style={styles.loginButton} onPress={handleSubmit}>
              <Text style={[styles.login, styles.defaultFont]}>{loading? <ActivityIndicator size={"small"} color={COLORS.white} />:  "Sign Up"}</Text>
            </Pressable>
            <View style={styles.dhacContainer}>
              ...
              >
                <Text style={[styles.dhacSignup, styles.defaultFont]}>
                  Login
                </Text>
              </Pressable>
            </View>
